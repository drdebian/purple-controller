...
# purple_controller documentation build
...
from purple_controller import __version__ as release

# -- Project information -----------------------------------------------------

project = "purple_controller"
author = "QuantumBlack"
...
htmlhelp_basename = "purple_controllerdoc"
...
latex_documents = [
    (
        master_doc,
        "purple_controller.tex",
        "purple_controller Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "purple_controller",
        "Project purple_controller codebase.",
        "Data-Science",
    )
]
